...
class mainActivityDark extends StatefulWidget {
  @override
  _mainActivityDarkState createState() => _mainActivityDarkState();
}
...
class _mainActivityDarkState extends State<mainActivityDark> {
                  ...
                  child: OutlineButton(
                    ...
                    child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Text("Mic On/Off", style: TextStyle(color: Colors.white),)
                        ]
                    ),
                  ),
                ),
